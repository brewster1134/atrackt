  ...
  (function(root, factory) {
    ...
    return Atrackt = (function() {
      ...
      Atrackt.prototype.setEvent = function(eventsObject, context) {
        var eventType, globalEvent, objects, pluginEvent, _results;
        if (context == null) {
          context = this;
        }
        if (!eventsObject) {
        ...
        for (eventType in eventsObject) {
          ...
          _results.push($(objects).each((function(_this) {
            return function(index, element) {
              var globalIndex, pluginData, pluginIndex, pluginName, _base, _base1, _ref, _ref1, _ref2, _results1;
              ...
              if (context.name) {
                ...
                for (pluginName in _ref) {
                  ...
                  if (pluginIndex !== -1) {
                    _results1.push((_ref2 = pluginData._elements[eventType]) != null ? _ref2.splice(pluginIndex, 1) : void 0);
                  } else {
